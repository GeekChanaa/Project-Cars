...
class CreateHydraulicBoosterUnitTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Hydraulic_booster_unit', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Hydraulic_booster_unit');
    }
}
