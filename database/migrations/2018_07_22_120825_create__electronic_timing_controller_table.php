...
class CreateElectronicTimingControllerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Electronic_timing_controller', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Electronic_timing_controller');
    }
}
