...
class CreateOtherMiscellaneousPartsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_miscellaneous_parts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('other_miscellaneous_parts');
    }
}
