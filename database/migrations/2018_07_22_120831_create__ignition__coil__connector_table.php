...
class CreateIgnitionCoilConnectorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Ignition_Coil_Connector', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Ignition_Coil_Connector');
    }
}
