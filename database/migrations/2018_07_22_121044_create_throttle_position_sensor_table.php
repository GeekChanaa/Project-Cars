...
class CreateThrottlePositionSensorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('throttle_position_sensor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('throttle_position_sensor');
    }
}
