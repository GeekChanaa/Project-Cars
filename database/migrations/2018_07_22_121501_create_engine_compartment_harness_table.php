...
class CreateEngineCompartmentHarnessTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('engine_compartment_harness', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('engine_compartment_harness');
    }
}
