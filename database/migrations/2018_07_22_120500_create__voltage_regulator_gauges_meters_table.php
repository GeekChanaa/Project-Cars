...
class CreateVoltageRegulatorGaugesMetersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Voltage_regulatorGauges_meters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Voltage_regulatorGauges_meters');
    }
}
