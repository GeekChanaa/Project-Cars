...
class CreateElectricalSwitchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Electrical_switches', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Electrical_switches');
    }
}
