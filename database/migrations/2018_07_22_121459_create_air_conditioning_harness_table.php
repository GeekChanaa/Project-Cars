...
class CreateAirConditioningHarnessTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('air_conditioning_harness', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('air_conditioning_harness');
    }
}
