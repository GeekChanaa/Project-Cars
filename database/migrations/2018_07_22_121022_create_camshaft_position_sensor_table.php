...
class CreateCamshaftPositionSensorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('camshaft_position_sensor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('camshaft_position_sensor');
    }
}
