...
class CreateSpeedometerCalibratorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('speedometer_calibrator', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('speedometer_calibrator');
    }
}
