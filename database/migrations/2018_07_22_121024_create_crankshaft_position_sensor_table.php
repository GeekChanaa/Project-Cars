...
class CreateCrankshaftPositionSensorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crankshaft_position_sensor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('crankshaft_position_sensor');
    }
}
