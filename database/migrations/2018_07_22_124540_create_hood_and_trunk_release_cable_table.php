...
class CreateHoodAndTrunkReleaseCableTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hood_and_trunk_release_cable', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hood_and_trunk_release_cable');
    }
}
