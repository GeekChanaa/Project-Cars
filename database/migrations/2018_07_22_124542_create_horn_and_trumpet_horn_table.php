...
class CreateHornAndTrumpetHornTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('horn_and_trumpet_horn', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('horn_and_trumpet_horn');
    }
}
