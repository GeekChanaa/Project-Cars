...
class CreateEngineComputerManagementSystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('engine_computer_management_system', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('engine_computer_management_system');
    }
}
