...
class CreateTransmissionComputerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transmissiophcomputer', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transmissiophcomputer');
    }
}
