...
class CreateStabilizerBarsAndLinkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Stabilizer_bars_and_link', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Stabilizer_bars_and_link');
    }
}
