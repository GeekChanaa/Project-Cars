...
class CreateExhaustClampAndBracketTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Exhaust_clamp_and_bracket', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Exhaust_clamp_and_bracket');
    }
}
