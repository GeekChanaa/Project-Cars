...
class CreateCentralLockingSystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('central_locking_system', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('central_locking_system');
    }
}
