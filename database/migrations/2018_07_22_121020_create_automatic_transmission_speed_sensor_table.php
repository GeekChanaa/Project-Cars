...
class CreateAutomaticTransmissionSpeedSensorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('automatic_transmission_speed_sensor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('automatic_transmission_speed_sensor');
    }
}
