...
class CreateChassisControlComputerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chassis_control_computer', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('chassis_control_computer');
    }
}
