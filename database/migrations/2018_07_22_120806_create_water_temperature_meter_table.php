...
class CreateWaterTemperatureMeterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Water_temperature_meter', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Water_temperature_meter');
    }
}
