...
class CreateNeutralSafetySwitchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Neutral_Safety_Switch', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Neutral_Safety_Switch');
    }
}
