...
class CreateFuelPressureSensorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fuel_pressure_sensor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('fuel_pressure_sensor');
    }
}
