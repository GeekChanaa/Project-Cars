...
class CreateInjectionMoldedPartsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('injection_molded_parts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('injection_molded_parts');
    }
}
