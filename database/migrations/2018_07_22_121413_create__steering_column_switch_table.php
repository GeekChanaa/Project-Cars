...
class CreateSteeringColumnSwitchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Steering_column_switch', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Steering_column_switch');
    }
}
