...
class CreateAdhesiveTapeAndFoilTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adhesive_tape_and_foil', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('adhesive_tape_and_foil');
    }
}
