...
class CreateCruiseControlComputerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cruise_control_computer', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cruise_control_computer');
    }
}
