...
class CreateAdjustingMechanismTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adjusting_mechanism', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('adjusting_mechanism');
    }
}
