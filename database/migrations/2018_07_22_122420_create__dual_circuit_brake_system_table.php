...
class CreateDualCircuitBrakeSystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Dual_circuit_brake_system', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Dual_circuit_brake_system');
    }
}
