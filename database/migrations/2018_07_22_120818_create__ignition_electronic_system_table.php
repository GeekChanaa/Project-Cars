...
class CreateIgnitionElectronicSystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Ignition_electronic_system', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Ignition_electronic_system');
    }
}
