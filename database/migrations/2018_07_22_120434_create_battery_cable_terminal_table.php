...
class CreateBatteryCableTerminalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('battery_cable_terminal', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('battery_cable_terminal');
    }
}
