...
class CreateMiscellaneousElectronicsElectronicTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('miscellaneous_electronics_electronic', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('miscellaneous_electronics_electronic');
    }
}
