...
class CreateLicensePlateBracketTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('license_plate_bracket', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('license_plate_bracket');
    }
}
