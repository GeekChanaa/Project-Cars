...
class CreateFuelPressureRegulatorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Fuel_pressure_regulator', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('Fuel_pressure_regulator');
    }
}
