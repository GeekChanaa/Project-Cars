...
class CreateAirBagControlModuleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('air_bag_control_module', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('air_bag_control_module');
    }
}
